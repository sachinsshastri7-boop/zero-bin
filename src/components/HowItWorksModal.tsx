...
import { Shield, Key, Database, EyeOff, Lock, HelpCircle, X } from "lucide-react";
        ...
        <div className="mt-6 space-y-4">
          <div className="flex gap-4 p-4 rounded-xl border border-zinc-800 bg-zinc-900/40">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-400 leading-relaxed">
                Your plain text is encrypted locally using Web Crypto API (AES-GCM-256). The encryption key is generated strictly inside your browser instance.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 p-4 rounded-xl border border-zinc-800 bg-zinc-900/40">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-zinc-400 leading-relaxed">
                The decryption key is appended to the link after a hash (<code className="text-emerald-400">#</code>) symbol. Browsers <strong className="text-zinc-300">never send URL hash fragments to the server</strong> in HTTP requests.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 p-4 rounded-xl border border-zinc-800 bg-zinc-900/40">
            ...
            <div>
              <h4 className="text-sm font-semibold text-zinc-200 flex items-center gap-2">
                <Database className="h-4 w-4 text-emerald-400" /> Blind Server Storage
              </h4>
              <p className="mt-1 text-xs text-zinc-400 leading-relaxed">
                Our database receives only unreadable ciphertext and initialization vectors. Even database administrators cannot read your stored secrets.
              </p>
            </div>
          </div>
